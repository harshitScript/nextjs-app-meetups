...
const getStaticPaths = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://x_hrsht_x:hrsht-x007@cluster0.yos87.mongodb.net/nextjs-app-meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (MeetupDetailPage);
